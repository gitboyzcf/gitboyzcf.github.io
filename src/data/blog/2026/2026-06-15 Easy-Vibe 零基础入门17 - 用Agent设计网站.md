...
modDatetime: 2026-06-24 09:22:37
title: Easy-Vibe 零基础入门17：用设计和编程Agent设计网站 - 从Logo到上线
slug:
featured: false
draft: true
tags:
  ...
  - Vibe Coding
  - 零基础入门
description: 学习使用AI设计Agent和编程Agent协作，从Logo设计到网站结构规划到代码生成的完整流程。
---
...
> 本文整理自 [Datawhale Easy-Vibe 教程](https://datawhalechina.github.io/easy-vibe/zh-cn/stage-1/appendix-articles/example0-2/vibe-coding-tools-build-website-with-ai-coding-and-design-agents)，系列连载第 17 篇（完结篇）。
